...
const blogs = [
  {
    id: 'when-not-to-let-ai-finish-the-job',
    title: 'When NOT to Let the AI Finish the Job',
    excerpt: 'Two production systems, one lesson: the most valuable line of code in an automation platform is the one that stops and asks a human. Why UmrahFlow halts before the government portal and why my POS makes owners approve discounts.',
    date: 'August 02, 2026',
    tags: ['AI Agents', 'Human-in-the-Loop', 'Automation', 'Trust', 'Opinion'],
    icons: ['🤖', '✋', '🧑‍⚖️', '🔒', '⚖️'],
  },
  {
    id: 'multi-tenant-from-day-one-pos-saas',
    title: 'Multi-Tenant from Day One: Building for One Store, Architecting for SaaS',
    excerpt: 'My POS has exactly one customer, but every table has a tenantId. What multi-tenancy actually cost to add up front, what it buys later, and where the line is between preparing for SaaS and over-engineering.',
    date: 'July 26, 2026',
    tags: ['SaaS', 'Multi-Tenancy', 'Next.js', 'Architecture', 'Prisma'],
    icons: ['🏬', '🏢', '🔑', '🗄️', '📈'],
  },
  {
    id: 'designing-ui-for-repetitive-retail-work',
    title: 'Designing UI for People Who Do the Same 5 Actions 300 Times a Day',
    excerpt: 'Retail staff are not "users exploring an interface" — they are operators under time pressure. How I designed a POS around tabular numerals, state-only color, keyboard-first tills, and chrome that disappears into the sale.',
    date: 'July 19, 2026',
    tags: ['UI/UX', 'Tailwind CSS', 'Accessibility', 'Design Systems', 'POS'],
    icons: ['🖥️', '⌨️', '🔢', '🎨', '⚡'],
  },
  {
    id: 'modeling-real-store-tickets-and-bills-pos',
    title: 'Modeling a Real Cloth House: Why My POS Has Tickets AND Bills',
    excerpt: 'In a multi-department Pakistani cloth store, where a sale is recorded and where money is taken are different places. How that one domain insight shaped a Prisma schema of tickets, bills, shifts, and escalations.',
    date: 'July 12, 2026',
    tags: ['Prisma', 'PostgreSQL', 'Data Modeling', 'Next.js', 'Retail Tech'],
    icons: ['🧾', '💵', '🏬', '🗄️', '🧮'],
  },
  {
    id: 'taming-whatsapp-as-an-app-input',
    title: 'Taming WhatsApp as an App Input: Debouncing Albums, Draining Queues',
    excerpt: 'WhatsApp is a terrible API and a perfect UX. How UmrahFlow turns messy real-world messages — photo albums, doubles, voice notes — into clean records with a Twilio-compatible relay, debounced draining, and agent traces.',
    date: 'July 05, 2026',
    tags: ['WhatsApp', 'WAHA', 'Message Queues', 'Integrations', 'Python'],
    icons: ['💬', '📸', '⏳', '🔁', '🧵'],
  },
  {
    id: 'building-microservices-to-someone-elses-contract',
    title: 'Building Microservices to Someone Else\'s Contract',
    excerpt: 'The dashboard already existed; its ML services didn\'t. How I rebuilt two missing services to the exact API shape an existing app expected — without changing a line of dashboard code — and made five services start with one command.',
    date: 'June 28, 2026',
    tags: ['Microservices', 'FastAPI', 'Docker', 'API Design', 'DevOps'],
    icons: ['🧩', '📜', '🐳', '🔌', '🧪'],
  },
  {
    id: 'passport-ocr-mrz-claude-vision',
    title: 'Reading Passports with AI: Merging MRZ Parsing with Claude Vision',
    excerpt: 'MRZ parsing is deterministic but brittle; vision models read anything but can hallucinate. Why UmrahFlow\'s passport OCR cross-checks a local MRZ pass against a Claude vision pass — and falls back to OpenAI when it must.',
    date: 'June 21, 2026',
    tags: ['Claude', 'Computer Vision', 'OCR', 'Python', 'AI/ML'],
    icons: ['🛂', '👁️', '🤖', '🔍', '✅'],
  },
  {
    id: 'whatsapp-to-government-portal-visa-automation',
    title: 'From WhatsApp Photo to Government Portal: Automating Visa Processing',
    excerpt: 'How UmrahFlow takes a pilgrim from a WhatsApp message to a staged Umrah visa submission — an AI agent, passport OCR, a human-review dashboard, and a bridge into the Saudi Nusuk portal that deliberately stops one step short.',
    date: 'June 14, 2026',
